...
void setup() {
    ...
    A[2][0] = 0.0000;      A[2][1] =  0.0000;      A[2][2] =  1.0000;      A[2][3] = 0.0000;
    A[3][0] = 0.0000;      A[3][1] =  0.0000;      A[3][2] =  0.0000;      A[3][3] = 1.0000;
    ...
    C[1][0] =  0.0000;      C[1][1] =  1.0000;      C[1][2] =  0.0000;      C[1][3] =  0.0000;
